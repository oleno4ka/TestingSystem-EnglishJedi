...
EXEC dbo.uspAdd4AnswerVariants 
	...
	INSERT INTO [dbo].[Mark]
           ...
           ,[Value])
        VALUES
           (1,1,4),(2,1,5),(1,1,3),(2,3,2),(1,3,1),
		   (1,3,0),(1,1,2),(1,3,2),(1,3,0),(1,1,0),
		   (1,3,0),(1,1,0),(1,3,0),(1,1,0),(1,3,0),
		   (1,3,2),(1,1,3),(1,1,4),		  
		   (1,1,1),(1,1,2),(1,3,2),(2,4,4),
		   (2,4,0),(1,4,3),(1,3,0)
GO
...
( 6, 31), ( 6, 33),( 10, 21), ( 10, 26),( 10, 17), ( 10, 12),( 10, 11),( 11, 29),( 11, 32),( 18, 28), ( 18, 34), ( 21, 23),
( 21, 26),( 21, 16), ( 21, 12), ( 21, 9),( 22, 29),( 23, 29), ( 23, 32), ( 26, 29),( 26, 32),( 27, 23),( 27, 26),( 27, 16),
( 27, 12),( 27, 11),( 28, 38),( 28, 42), ( 28, 44), ( 29, 37), (29, 41), ( 30, 38), ( 30, 42),( 30, 45)
