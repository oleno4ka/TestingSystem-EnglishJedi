...
EXEC dbo.uspAdd4AnswerVariants 
	...
	INSERT INTO [dbo].[Mark]
           ...
           ,[Value])
     VALUES
           (1,1,4),(2,1,5),(1,1,3),(2,3,2),(1,3,1),(1,3,0),(1,1,2),(1,3,2),
		   (1,3,0),(1,1,0),(1,3,0),(1,1,0),(1,3,0),(1,1,0),(1,3,0),(1,3,2),
		   (1,1,3),(1,1,4),(4,3,1),(4,3,2),(1,1,1),(1,1,2),(1,3,2),(4,1,4),
		   (2,4,4),(2,4,0),(1,4,3),(1,3,0)
GO
...
( 27, 12),( 27, 11),( 28, 38),( 28, 42), ( 28, 44),( 28, 50), ( 28, 54), ( 29, 37), (29, 41), ( 30, 38), ( 30, 42),( 30, 45),
( 30, 51), ( 30, 54)